...
import { IsBoolean, IsDate, IsNotEmpty, IsOptional, IsString, Matches, ValidateIf } from "class-validator";
...
export class UpdateUser{
    ...
    @ApiProperty({description: "avatar",required: false, type: 'string', format: 'binary'})
    // @IsString()
    avatar: string;
}